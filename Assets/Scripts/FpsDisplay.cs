...
{
    [SerializeField]
    private TMPro.TextMeshProUGUI _averageLabel;
    [SerializeField]
    private TMPro.TextMeshProUGUI _highestLabel;
    [SerializeField]
    private TMPro.TextMeshProUGUI _lowestLabel;
    ...
    private void Display(TMPro.TextMeshProUGUI label, int fps)
    {
